...
function diploma(){    
    container.innerHTML=`<div class="wrapper" style="max-width: 297mm;">
            <div id="section-to-print" class="container" style="background-image: url(./Diploma/assets/img/svg/bg.svg); background-size: contain; width: 297mm; height: 210mm;">
                <h1 >грамота</h1>
                <h2 >Почетная</h2>
                <h3 >Награждается:</h3>
...
function lesorub(){
    container.innerHTML=`<div class="wrapper" style="max-width: 210mm;">
            <div id="section-to-print" class="container" style="background-image: url(./Diploma/assets/img/fon.png); background-size: contain; width: 210mm; height: 297mm;">
